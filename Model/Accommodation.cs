...
namespace BookingApp.Model
{
    public class Accommodation : ISerializable
    {
        ...
        public Accommodation(string name,Enums.AccommodationType type,int maxGuests,int minReservationDays,int cancelationDays)
        {
            Name = name;
            Type = type;    
            MaxGuests = maxGuests;
        ...
        public string[] ToCSV()
        {
            string[] csvValues = { Id.ToString(), Name, Type.ToString(), MaxGuests.ToString(), MinReservationDays.ToString(), CancelationDays.ToString() };
            return csvValues;
        }
